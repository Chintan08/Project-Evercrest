...
class rustic_chestplate:
    ...
    name = f"{colors.White}Rustic Chestplate{colors.Reset}"

    # ADD ALL VARIABLES CHANGED TO DESCRIPTION
    desc = f"This chestplate has had better days, but it still protects you, technically..." \
    ...
    def print_recipe():
        string = ""
        for key in rustic_chestplate.recipe:
            string = f"{string}| {rustic_chestplate.recipe[key]}x {key.name} | "
