...
class prediction_duelist:
    ...
    def special(self, combat, caster, casted):
        ...
        if self.cur_cd <= 0 and combat.swings[0].name == prediction_duelist.name and combat.swing != 0 and combat.mobs[0] == caster:
    ...
    def check_effect(self, combat, caster, casted):
        ...
        if effect_count < prediction.stack:  # changes how many times this effect can stack
            combat.effects[casted.type].append(prediction(combat, caster, casted, duelist, 1))
